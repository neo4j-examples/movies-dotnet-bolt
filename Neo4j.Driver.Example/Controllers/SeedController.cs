        ...
        public IHttpActionResult Get()
        {
            var statementTemplate =
                ...
                "CREATE  (Keanu)-[:ACTED_IN {roles:['Neo']}]->(TheMatrixReloaded),  \n" +
                    ...
                    "(AndyW)-[:DIRECTED]->(TheMatrixReloaded),  (LanaW)-[:DIRECTED]->(TheMatrixReloaded),  \n" +
                ...
                "CREATE  (Keanu)-[:ACTED_IN {roles:['Neo']}]->(TheMatrixRevolutions),  \n" +
                    ...
                    "(AndyW)-[:DIRECTED]->(TheMatrixRevolutions),  (LanaW)-[:DIRECTED]->(TheMatrixRevolutions),  \n" +
                    "(JoelS)-[:PRODUCED]->(TheMatrixRevolutions)\n" +
                "CREATE (TheDevilsAdvocate:Movie {title:'The Devils Advocate', released:1997, tagline:'Evil has its winning ways'})\n" +
                "CREATE (Charlize:Person {name:'Charlize Theron', born:1975})CREATE (Al:Person {name:'Al Pacino', born:1940})\n" +
                ...
                "CREATE (KellyM:Person {name:'Kelly McGillis', born:1957})CREATE (ValK:Person {name:'Val Kilmer', born:1959})\n" +
                ...
                "CREATE  (TomC)-[:ACTED_IN {roles:['Maverick']}]->(TopGun),  \n" +
                    ...
                    "(TonyS)-[:DIRECTED]->(TopGun),  (JimC)-[:WROTE]->(TopGun)\n" +
                ...
                "CREATE  (EmileH)-[:ACTED_IN {roles:['Speed Racer']}]->(SpeedRacer),  \n" +
                    ...
                    "(AndyW)-[:DIRECTED]->(SpeedRacer),  (LanaW)-[:DIRECTED]->(SpeedRacer),  \n" +
                    "(AndyW)-[:WROTE]->(SpeedRacer),  (LanaW)-[:WROTE]->(SpeedRacer),  \n" +
                ...
                "CREATE (DianeK:Person {name:'Diane Keaton', born:1946})CREATE (NancyM:Person {name:'Nancy Meyers', born:1949})\n" +
            ...
            using (var session = WebApiConfig.Neo4jDriver.Session(AccessMode.Write))
            {
